...
def main():
    parser = argparse.ArgumentParser(description="Program 3: exact rolling average subscriber.")
    ...
    window_seconds = args.window or cfg["program3"]["window_seconds"]
    print_every_seconds = cfg["program3"]["print_every_seconds"]

    def on_connect(client, userdata, flags, reason_code, properties=None):
        if reason_code == 0:
            print(f"Connected. Subscribing to {topic} | window={window_seconds}s")
